	    ...
	    try {
	        ...
	        if (test_connection == null) {
	            ...
	            while (result_gallery_all.next()) {
	                String query_gallery = "select * from gallery a inner join image b on a.gallery_id=b.gallery_id where a.gallery_id=" + result_gallery_all.getString("gallery_id")+";";
	                ...
	                out.println("<tr><td>" + tmp + "</td><td>" + result_gallery_all.getString("description") + "</td><td>");
